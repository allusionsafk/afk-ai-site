...
Security and privacy reports for the AFK AI website and installer distribution path use the main AFK AI security policy.
...
The deployed site publishes `/.well-known/security.txt`, which points to the same private reporting policy.
