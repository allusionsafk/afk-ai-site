...
This repository contains the AFK AI public website and pinned Beta download route.
...
3. Preserve the pinned Beta download behaviour unless the pull request is a reviewed release update.
